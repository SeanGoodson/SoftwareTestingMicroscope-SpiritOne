...
namespace {
	...
	const Status_txt::value_type rawData[] =
	{
		...
		Status_txt::value_type(OphirLMMeasurement::frequency,		L"frequency"),
		Status_txt::value_type(OphirLMMeasurement::temperature,		L"temperature"),
		Status_txt::value_type(OphirLMMeasurement::alertHot,		L"alertHot"),
		Status_txt::value_type(OphirLMMeasurement::pulseWidth,		L"pulseWidth"),
		Status_txt::value_type(OphirLMMeasurement::pfpEnergy,		L"pfpEnergy")
	};
